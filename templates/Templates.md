---
tags: [templates, boilerplate, reference]
...
- `FredTrivett/supabase-auth-boilerplate` — Next.js 14 + TS, email-auth, защищённые роуты, профили, Resend-шаблоны.
- `mmvergara/react-supabase-auth-template` — минимальный React + Supabase auth.
- Официальный стартер Vercel `next.js/supabase` — cookie-based SSR auth.
